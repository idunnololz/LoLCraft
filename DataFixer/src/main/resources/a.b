...
"Akali",    1,  METHOD_DPS,         1, 1, 0, 0.06, 0.01/6, "spelldamage", "PercentPhysicalDamageMod",
            ...
            1,  METHOD_AOE_BURST|AD,2, 30, 55, 80, 105, 130, 0.4, "spelldamage", 0.6, "attackdamage",
...
"Braum",    2,  METHOD_CC,          0, CC_AOE_STUN, 3, 1, 1.25, 7, 1.5, 13, 1.75,
            ...
            2,  METHOD_BURST|AP,    1, 70, 115, 160, 205, 250, 0.025, "health",
...
"Evelynn",  0,
            1,  METHOD_AOE_BURST|AP,2, 40, 50, 60, 70, 80, 0.35, 0.4, 0.45, 0.5, 0.55, "spelldamage", 0.5, 0.55, 0.6, 0.65, 0.7, "attackdamage",
            ...
            2,  METHOD_CC,          0, CC_AOE_SLOW, 0.4, 2, 0.6, 2, 0.8, 2,
...
"Galio",    0,
            ...
            2,  METHOD_TANK,        0, 0.5, 0.5, 0.5, "damagereduction",
                METHOD_AOE_BURST|AP,1, 360, 540, 720, 1, "spelldamage",
...
"Gragas",   0,
            2,  METHOD_AOE_BURST|AP,1, 120, 180, 240, 300, 360, 0.9, "spelldamage",
                METHOD_CC,          0, CC_AOE_SLOW, 0.45, 1.3, 0.525, 1.3, 0.6, 1.3, 0.675, 1.3, 0.75, 1.3,
...
"Graves",   2,  METHOD_TANK,        0, 3, 1, 10, 7, 20, 13, 30, "FlatArmorMod",
            ...
            1,  METHOD_AOE_BURST|AD,1, 60, 90, 120, 150, 180, 0.75, "bonusattackdamage",
            ...
            1,  METHOD_AOE_BURST|AD,1, 250, 400, 550, 1.5, "bonusattackdamage",
...
"Jax",      1,  METHOD_DPS,         0, 1, 6, 1, 0.24, 4, 0.36, 7, 0.48, 10, 0.6, 13, 0.72, 16, 0.84, "PercentAttackSpeedMod",
            ...
            3,  METHOD_TANK,        1, 30, 50, 70, 0.5, "bonusattackdamage", "FlatArmorMod",
                METHOD_TANK,        1, 30, 50, 70, 0.2, "spelldamage", "FlatSpellBlockMod",
                METHOD_DPS,         1, 1, 33.33, 53.33, 73.33, 0.2333, "spelldamage", "FlatAaMagicDamageMod",

"Jinx",     1,  METHOD_MOBILITY,    0, MOBI_MSP, 0, 1.75,
            1,  METHOD_DPS,         0, 1, 0.3, 0.4, 0.5, 0.6, 0.7, "PercentAttackSpeedMod",
            ...
            1,  METHOD_AOE_BURST|AD,2, 25, 35, 45, 0.1, "bonusattackdamage", 0.25, 0.3, 0.35, "enemymissinghealth",
...
"Katarina", 0,
            ...
            2,  METHOD_BURST|AP,    1, 40, 70, 100, 130, 160, 0.25, "spelldamage",
...
"Kayle",    0,
            ...
            2,  METHOD_DPS,         1, 1, 20, 30, 40, 50, 60, 0.3, "spelldamage", "FlatAaMagicDamageMod",
...
"Lissandra",0,
            2,  METHOD_AOE_BURST|AP,1, 70, 100, 130, 160, 190, 0.65, "spelldamage",
...
"Malphite", 1,  METHOD_TANK,        1, 0, 0, 0.1, "health", "FlatHPPoolMod",
            ...
            2,  METHOD_DPS,         2, 1, 15, 30, 45, 60, 75, 0.1, "spelldamage", 0.1, "armor", "FlatPhysicalDamageMod",
                METHOD_TANK,        1, 0, 0, 0, 0, 0, 0.1, 0.15, 0.2, 0.25, 0.3, "bonusarmor", "FlatArmorMod",
...
"MissFortune",1,  METHOD_MOBILITY,  0, MOBI_FLAT_MS, 0, 70,
            ...
            2,  METHOD_AOE_BURST|AP,1, 90, 145, 200, 255, 310, 0.8, "spelldamage",
                METHOD_CC,          0, CC_AOE_SLOW, 0.4, 3, 0.45, 3, 0.5, 3, 0.55, 3, 0.60, 3,
...
"Morgana",  0,
            ...
            1,  METHOD_DOT_BURST|AP,1, 80, 160, 240, 320, 400, 1.1, "spelldamage",
...
"Nautilus", 2,  METHOD_BURST|AD,    1, 0, 2, 6, "level",
            ...
            3,  METHOD_AOE_BURST|AP,1, 60, 105, 150, 195, 240, 0.75, "spelldamage",
                ...
                METHOD_MOBILITY,    0, MOBI_DASH, 1100, 1100, 1100, 1100, 1100,
            2,  METHOD_TANK,        1, 65, 70, 75, 80, 85, 0.09, 0.11, 0.13, 0.15, 0.17, "health", "FlatHPPoolMod",
                METHOD_DOT_BURST|AP,1, 30, 40, 50, 60, 70, 0.4, "spelldamage",
            2,  METHOD_AOE_BURST|AP,1, 60, 95, 130, 165, 200, 0.3, "spelldamage",
...
"Nocturne", 1,  METHOD_AOE_BURST|AD,1, 0, 0, 1.2, "attackdamage",
            ...
            2,  METHOD_DOT_BURST|AP,1, 80, 120, 160, 200, 260, 1, "spelldamage",
...
"Ryze",     0,
            1,  METHOD_AOE_BURST|AP,2, 60, 85, 110, 135, 160, 0.55, "spelldamage", 0.02, 0.025, 0.03, 0.035, 0.04, "mana",
            2,  METHOD_AOE_BURST|AP,2, 80, 100, 120, 140, 160, 0.4, "spelldamage", 0.025, "mana"
                METHOD_CC,          0, CC_ROOT, 1, 1.1, 1.2, 1.3, 1.4,
            1,  METHOD_AOE_BURST|AP,2, 36, 52, 68, 84, 100, 0.2, "spelldamage", 0.01, "mana",
...
"Sejuani",  1,  METHOD_TANK,        0, 4, 1, 10, 7, 15, 12, 20, 17, 25, "FlatArmorMod",
            3,  METHOD_BURST|AP,    1, 80, 125, 170, 215, 260, 0.4, "spelldamage",
                ...
                METHOD_MOBILITY,    0, MOBI_DASH, 650, 650, 650, 650, 650,
            2,  METHOD_AOE_DOT_BURST|AP,2, 40, 70, 100, 130, 160, 0.04, 0.045, 0.05, 0.055, 0.06, "health", 0.6, "spelldamage",
...
"Sivir",	1, 	METHOD_MOBILITY,	0, MOBI_FLAT_MS, 5, 1, 30, 6, 35, 11, 40, 16, 45, 18, 50,
            ...
            0,
            0,
            2,	METHOD_MOBILITY,	0, MOBI_MSP, 0.4, 0.5, 0.6,
...
"Skarner",  2,  METHOD_BURST|AP,    2, 0, 15, 5, "level", 1, "attackdamage",
            ...
            1,  METHOD_AOE_BURST|AP,1, 20, 30, 40, 50, 60, 0.4, "bonusattackdamage",
            2,  METHOD_TANK,        1, 80, 135, 190, 245, 300, 0.8, "spelldamage", "FlatHPPoolMod",
                METHOD_MOBILITY,    0, MOBI_MSP, 0.16, 0.2, 0.24, 0.28, 0.32,
            2,  METHOD_AOE_BURST|AP,1, 40, 75, 110, 145, 180, 0.4, "spelldamage",
...
"Trundle",  0,
            ...
            3,  METHOD_CC,          0, CC_WALL, 6, 6, 6, 6, 6,
                METHOD_CC,          0, CC_AOE_DISPLACE, 225, 225, 225, 225, 225,
                METHOD_CC,          0, CC_SLOW, 0.3, 6, 0.35, 6, 0.4, 6, 0.45, 6, 0.5, 6,
            1,  METHOD_DOT_BURST|AP,1, 0, 0, 0, 0.2, 0.275, 0.35, "enemymaxhealth",
...
"XinZhao",  0,
            ...
            5,  METHOD_CC,          0, CC_AOE_DISPLACE, 1, 1, 1,
                METHOD_CC,          0, CC_AOE_STUN, 0.75, 0.75, 0.75,
